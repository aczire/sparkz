...
public class WordCount {
	public static void main(String[] args) {
		...
		System.out.println("Wordcount: " + counts.collect());
		System.out.println("Wordcount over threshold: " + filtered.collect());
		System.out.println("Character Frequency: " + charCounts.collect());
